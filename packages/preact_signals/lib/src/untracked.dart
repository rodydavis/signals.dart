...
///
/// Normally, reading a signal's value (via `.value` or `()`) inside an [effect] or a [computed] callback
...
/// a subscription. This is where [untracked] is useful. It temporarily suspends active tracking, executes [fn],
