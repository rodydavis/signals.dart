...
##### <a name="signalcustompainter"></a><a name="signalcustompainter"></a>`SignalCustomPainter({required this.signals})`
...
##### <a name="paint"></a>`void paint(Canvas canvas, Size size)`

Paint on the canvas.

##### <a name="shouldrepaint"></a>`bool shouldRepaint(covariant SignalCustomPainter oldDelegate)`
