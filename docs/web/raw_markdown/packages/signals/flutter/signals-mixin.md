...
- Use [SignalBuilder](/packages/signals/flutter/watch) for surgical, localized rebuilding.
</Warning>
...
Async Computed is syntax sugar around [FutureSignal](/packages/signals/async/future).
...
of the signal. This callback is converted into a [Computed](/packages/signals/core/computed) signal.
