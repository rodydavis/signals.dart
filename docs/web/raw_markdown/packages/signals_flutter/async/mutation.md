...
##### <a name="mutationsignal"></a><a name="mutationsignal"></a>`MutationSignal(this._mutator, {SignalOptions<MutationState<T>>? options})`
...
##### <a name="variables"></a>`A? variables`
...
##### <a name="mutateasync"></a>`Future<T> mutateAsync(A arg)`
...
##### <a name="mutate"></a>`void mutate(A arg)`
...
##### <a name="mutationstate"></a><a name="mutationstate"></a>`MutationState()`

Const constructor for [MutationState](/types/mutationstate) subclasses.

##### <a name="mutationstate-idle"></a><a name="idle"></a>`MutationState.idle()`

Create an [MutationIdle](/types/mutationidle) state (the mutation has not been run yet).

##### <a name="mutationstate-pending"></a><a name="pending"></a>`MutationState.pending()`

Create a [MutationPending](/types/mutationpending) state (the mutation is running).

##### <a name="mutationstate-data"></a><a name="data"></a>`MutationState.data(T data)`

Create a [MutationSuccess](/types/mutationsuccess) state with a resolved value.

##### <a name="mutationstate-error"></a><a name="error"></a>`MutationState.error(Object error, [StackTrace? stackTrace])`
...
##### <a name="map"></a>`E map({required MutationStateBuilder<E> idle, required MutationStateBuilder<E> pending, required MutationDataBuilder<E, T> data, required MutationErrorBuilder<E> error})`
...
##### <a name="maybemap"></a>`E maybeMap({MutationStateBuilder<E>? idle, MutationStateBuilder<E>? pending, MutationDataBuilder<E, T>? data, MutationErrorBuilder<E>? error, required MutationStateBuilder<E> orElse})`
