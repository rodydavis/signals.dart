---
title: "Type: ActionExt6"
description: "API reference and details for ActionExt6 from signals.dart."
---
...
## Extension: ActionExt6

```dart
extension ActionExt6 on R Function(A, B, C, D, E, F)
```

Extension on a 6-argument function to wrap it in a type-safe action.

### Members of ActionExt6

| Member | Type | Signature | Description |
| :--- | :--- | :--- | :--- |
| **action** | <code>method</code> | <code>dart R Function(A, B, C, D, E, F) action</code> | Wraps the 6-argument function in a type-safe action. |

## References

The **ActionExt6** type is referenced and used in the following pages:
