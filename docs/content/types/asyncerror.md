---
title: "Type: AsyncError"
description: "API reference and details for AsyncError from signals.dart."
---
...
| :--- | :--- | :--- | :--- |
| **AsyncError** | <code>constructor</code> | <code>dart AsyncError(this.error, this.stackTrace)</code> | State for an [AsyncState](/types/asyncstate) with an error |
...
| **stackTrace** | <code>field</code> | <code>dart StackTrace stackTrace</code> |  |
