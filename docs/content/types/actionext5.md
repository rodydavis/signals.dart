---
title: "Type: ActionExt5"
description: "API reference and details for ActionExt5 from signals.dart."
---
...
## Extension: ActionExt5

```dart
extension ActionExt5 on R Function(A, B, C, D, E)
```

Extension on a 5-argument function to wrap it in a type-safe action.

### Members of ActionExt5

| Member | Type | Signature | Description |
| :--- | :--- | :--- | :--- |
| **action** | <code>method</code> | <code>dart R Function(A, B, C, D, E) action</code> | Wraps the 5-argument function in a type-safe action. |

## References

The **ActionExt5** type is referenced and used in the following pages:
