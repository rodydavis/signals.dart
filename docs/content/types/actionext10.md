---
title: "Type: ActionExt10"
description: "API reference and details for ActionExt10 from signals.dart."
---
...
## Extension: ActionExt10

```dart
extension ActionExt10 on R Function(A, B, C, D, E, F, G, H, I, J)
```

Extension on a 10-argument function to wrap it in a type-safe action.

### Members of ActionExt10

| Member | Type | Signature | Description |
| :--- | :--- | :--- | :--- |
| **action** | <code>method</code> | <code>dart R Function(A, B, C, D, E, F, G, H, I, J) action</code> | Wraps the 10-argument function in a type-safe action. |

## References

The **ActionExt10** type is referenced and used in the following pages:
