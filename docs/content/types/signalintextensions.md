---
title: "Type: SignalIntExtensions"
description: "API reference and details for SignalIntExtensions from signals.dart."
---
...
| :--- | :--- | :--- | :--- |
| **$** | <code>method</code> | <code>dart Signal<int> $</code> | Return a signal from a int value |

## References

The **SignalIntExtensions** type is referenced and used in the following pages:
