---
title: "Type: onSignalRead"
description: "API reference and details for onSignalRead from signals.dart."
---

# onSignalRead

<Info>
  <strong>Kind:</strong> <code>variable</code> &nbsp;|&nbsp;
...
The **onSignalRead** type is referenced and used in the following pages:
