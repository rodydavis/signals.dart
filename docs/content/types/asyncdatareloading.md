---
title: "Type: AsyncDataReloading"
description: "API reference and details for AsyncDataReloading from signals.dart."
---
...
| :--- | :--- | :--- | :--- |
| **AsyncDataReloading** | <code>constructor</code> | <code>dart AsyncDataReloading(super.data)</code> | Create a state with a value that is reloading |
