---
title: "Type: SignalEnumExtensions"
description: "API reference and details for SignalEnumExtensions from signals.dart."
---
...
```dart
extension SignalEnumExtensions on T
```
...
| :--- | :--- | :--- | :--- |
| **$** | <code>method</code> | <code>dart Signal<T> $</code> | Return a signal from a Enum value |

## References

The **SignalEnumExtensions** type is referenced and used in the following pages:
