---
title: "Type: FlutterReadonlySignal"
description: "API reference and details for FlutterReadonlySignal from signals.dart."
---
...
The **FlutterReadonlySignal** type is referenced and used in the following pages:
