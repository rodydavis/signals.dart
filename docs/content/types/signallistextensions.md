---
title: "Type: SignalListExtensions"
description: "API reference and details for SignalListExtensions from signals.dart."
---
...
```dart
extension SignalListExtensions on List<E>
```
...
| :--- | :--- | :--- | :--- |
| **$** | <code>method</code> | <code>dart Signal<List<E>> $</code> | Return a signal from a List value |

## References

The **SignalListExtensions** type is referenced and used in the following pages:
