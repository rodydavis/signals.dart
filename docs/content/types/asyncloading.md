---
title: "Type: AsyncLoading"
description: "API reference and details for AsyncLoading from signals.dart."
---
...
| :--- | :--- | :--- | :--- |
| **AsyncLoading** | <code>constructor</code> | <code>dart AsyncLoading()</code> | State for an [AsyncState](/types/asyncstate) with a loading state |
...
The **AsyncLoading** type is referenced and used in the following pages:
