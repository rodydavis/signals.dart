---
title: "Type: AsyncErrorRefreshing"
description: "API reference and details for AsyncErrorRefreshing from signals.dart."
---
...
| :--- | :--- | :--- | :--- |
| **AsyncErrorRefreshing** | <code>constructor</code> | <code>dart AsyncErrorRefreshing(super.error, super.stackTrace)</code> | Create a state with an error that is refreshing |
