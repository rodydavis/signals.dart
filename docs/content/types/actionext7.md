---
title: "Type: ActionExt7"
description: "API reference and details for ActionExt7 from signals.dart."
---
...
## Extension: ActionExt7

```dart
extension ActionExt7 on R Function(A, B, C, D, E, F, G)
```

Extension on a 7-argument function to wrap it in a type-safe action.

### Members of ActionExt7

| Member | Type | Signature | Description |
| :--- | :--- | :--- | :--- |
| **action** | <code>method</code> | <code>dart R Function(A, B, C, D, E, F, G) action</code> | Wraps the 7-argument function in a type-safe action. |

## References

The **ActionExt7** type is referenced and used in the following pages:
