---
title: "Type: ActionExt8"
description: "API reference and details for ActionExt8 from signals.dart."
---
...
## Extension: ActionExt8

```dart
extension ActionExt8 on R Function(A, B, C, D, E, F, G, H)
```

Extension on an 8-argument function to wrap it in a type-safe action.

### Members of ActionExt8

| Member | Type | Signature | Description |
| :--- | :--- | :--- | :--- |
| **action** | <code>method</code> | <code>dart R Function(A, B, C, D, E, F, G, H) action</code> | Wraps the 8-argument function in a type-safe action. |

## References

The **ActionExt8** type is referenced and used in the following pages:
