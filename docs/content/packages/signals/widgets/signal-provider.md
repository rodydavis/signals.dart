...
##### <a name="signalprovider"></a><a name="signalprovider"></a><code>SignalProvider({super.key, required T Function() create, this.child, this.dispose})</code>
...
##### <a name="signalprovider-value"></a><a name="value"></a><code>SignalProvider.value({super.key, required T value, this.child})</code>
...
##### <a name="signalprovider-_"></a><a name="_"></a><code>SignalProvider._({super.key, required T Function()? create, required T? value, required this.child, required this.dispose})</code>

Private constructor for internal cloning and subclass usage.

##### <a name="signalprovider-multi"></a><a name="multi"></a><code>SignalProvider.multi({Key? key, required List<SignalProvider> providers, required Widget child})</code>
...
##### <a name="dispose"></a><code>void Function(T)? dispose</code>
...
##### <a name="copywith"></a><code>SignalProvider<T> copyWith(Widget child)</code>
...
##### <a name="createstate"></a><code>State<SignalProvider<T>> createState()</code>

##### <a name="providerof"></a><code>static SignalProvider<T>? providerOf(BuildContext context, {bool listen = true})</code>
...
##### <a name="of"></a><code>static T? of(BuildContext context, {bool listen = true})</code>
