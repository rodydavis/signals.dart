...
##### <a name="signalanimatedbuilder"></a><a name="signalanimatedbuilder"></a><code>SignalAnimatedBuilder({super.key, required this.builder, this.child, this.debugLabel, this.dependencies = const []})</code>
...
##### <a name="builder"></a><code>Widget Function(BuildContext context, Widget? child) builder</code>
