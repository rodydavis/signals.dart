...
##### <a name="signalmodel"></a><a name="signalmodel"></a><code>SignalModel(this.value, this._effects, {this.options = const SignalModelOptions()})</code>
...
##### <a name="options"></a><code>SignalModelOptions options</code>
...
##### <a name="signalmodeloptions"></a><a name="signalmodeloptions"></a><code>SignalModelOptions({this.name, this.wrapInAction = true})</code>
...
##### <a name="wrapinaction"></a><code>bool wrapInAction</code>
...
##### <a name="copywith"></a><code>SignalModelOptions copyWith({String? name, bool? wrapInAction})</code>
...
##### <a name="signalmodelconstructor"></a><a name="signalmodelconstructor"></a><code>SignalModelConstructor(this._factory, {this.options = const SignalModelOptions()})</code>
...
##### <a name="call"></a><code>SignalModel<T> call()</code>
