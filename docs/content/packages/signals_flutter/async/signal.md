...
##### <a name="asyncsignal"></a><a name="asyncsignal"></a><code>AsyncSignal(super.value, {super.options})</code>
...
##### <a name="setvalue"></a><code>void setValue(T value)</code>

Set the value to [AsyncData](/types/asyncdata)

##### <a name="setloading"></a><code>void setLoading([AsyncState<T>? state])</code>
...
##### <a name="timersignal"></a><a name="timersignal"></a><code>TimerSignal({required this.every, super.cancelOnError, AsyncSignalOptions<TimerSignalEvent>? options, @Deprecated('Use options: AsyncSignalOptions(autoDispose: ...) instead') bool? autoDispose, @Deprecated('Use options: AsyncSignalOptions(name: ...) instead') String? debugLabel})</code>
...
##### <a name="every"></a><code>Duration every</code>
...
##### <a name="asyncsignaloptions"></a><a name="asyncsignaloptions"></a><code>AsyncSignalOptions({this.initialValue, this.dependencies = const [], this.onDone, this.cancelOnError, this.lazy = true, super.name, super.autoDispose, super.watched, super.unwatched})</code>
...
##### <a name="ondone"></a><code>void Function()? onDone</code>
...
##### <a name="lazy"></a><code>bool lazy</code>
...
##### <a name="copywith"></a><code>AsyncSignalOptions<T> copyWith({T? initialValue, List<ReadonlySignal<dynamic>>? dependencies, void Function()? onDone, bool? cancelOnError, bool? lazy, bool? autoDispose, String? name, void Function()? watched, void Function()? unwatched})</code>
...
##### <a name="tosignal"></a><code>TimerSignal toSignal({bool? cancelOnError, AsyncSignalOptions<TimerSignalEvent>? options, @Deprecated('Use options: AsyncSignalOptions(autoDispose: ...) instead') bool? autoDispose, @Deprecated('Use options: AsyncSignalOptions(name: ...) instead') String? debugLabel})</code>
