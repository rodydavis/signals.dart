...
'''
    ...
    case 'signals_devtools_extension':
      return {
        'overview': 'The `signals_devtools_extension` package installs a custom visual debugging tool directly inside Flutter DevTools. It provides visual insights, timeline updates, and reactive relationship diagrams of all active signals in your application.',
        'features': '''
