...
| [Watch](file:///Users/rodydavis/.gemini/antigravity/worktrees/signals.dart/update-vscode-signals-extension/skills/signals-flutter/api/Watch.md) | `class` | A deprecated widget for watching signal changes in the widget tree. |
| [WatchBuilder](file:///Users/rodydavis/.gemini/antigravity/worktrees/signals.dart/update-vscode-signals-extension/skills/signals-flutter/api/WatchBuilder.md) | `class` | WatchBuilder |
...
| [SignalsMixin](file:///Users/rodydavis/.gemini/antigravity/worktrees/signals.dart/update-vscode-signals-extension/skills/signals-flutter/api/SignalsMixin.md) | `mixin` | A State mixin that automatically handles subscription and cleanup of signals |
